...
data_num=[60, 160, 320]
block=np.zeros((3, 4))
for num in np.arange(0, len(data_num)):
    m=data_num[num]
    def linear_model(x):
    ...
    Wlin=X_total.dot(y[0:int(m*0.75-1)])

    #Formula after Regression
    y_regress=Wlin[0]*(x[0:int(m*0.75-1)]**14)+Wlin[1]*(x[0:int(m*0.75-1)]**13)+Wlin[2]*(x[0:int(m*0.75-1)]**12)+Wlin[3]*(x[0:int(m*0.75-1)]**11) \
        +Wlin[4]*(x[0:int(m*0.75-1)]**10)+Wlin[5]*(x[0:int(m*0.75-1)]**9)+Wlin[6]*(x[0:int(m*0.75-1)]**8)+Wlin[7]*(x[0:int(m*0.75-1)]**7)+Wlin[8]*(x[0:int(m*0.75-1)]**6)\
            +Wlin[9]*(x[0:int(m*0.75-1)]**5)+Wlin[10]*(x[0:int(m*0.75-1)]**4)+Wlin[11]*(x[0:int(m*0.75-1)]**3)+Wlin[12]*(x[0:int(m*0.75-1)]**2)+Wlin[13]*(x[0:int(m*0.75-1)]**1)+Wlin[14]*(x[0:int(m*0.75-1)]**0)

    #training error
    y_regress_training=Wlin[0]*(x[0:int(m*0.75-1)]**14)+Wlin[1]*(x[0:int(m*0.75-1)]**13)+Wlin[2]*(x[0:int(m*0.75-1)]**12)+Wlin[3]*(x[0:int(m*0.75-1)]**11) \
        +Wlin[4]*(x[0:int(m*0.75-1)]**10)+Wlin[5]*(x[0:int(m*0.75-1)]**9)+Wlin[6]*(x[0:int(m*0.75-1)]**8)+Wlin[7]*(x[0:int(m*0.75-1)]**7)+Wlin[8]*(x[0:int(m*0.75-1)]**6)\
            +Wlin[9]*(x[0:int(m*0.75-1)]**5)+Wlin[10]*(x[0:int(m*0.75-1)]**4)+Wlin[11]*(x[0:int(m*0.75-1)]**3)+Wlin[12]*(x[0:int(m*0.75-1)]**2)+Wlin[13]*(x[0:int(m*0.75-1)]**1)+Wlin[14]*(x[0:int(m*0.75-1)]**0)
    ...
    #testing error
    y_regress_test=Wlin[0]*(x[int(m*0.75):m-1]**14)+Wlin[1]*(x[int(m*0.75):m-1]**13)+Wlin[2]*(x[int(m*0.75):m-1]**12)+Wlin[3]*(x[int(m*0.75):m-1]**11)\
        +Wlin[4]*(x[int(m*0.75):m-1]**10)+Wlin[5]*(x[int(m*0.75):m-1]**9)+Wlin[6]*(x[int(m*0.75):m-1]**8)+Wlin[7]*(x[int(m*0.75):m-1]**7)+Wlin[8]*(x[int(m*0.75):m-1]**6)\
            +Wlin[9]*(x[int(m*0.75):m-1]**5)+Wlin[10]*(x[int(m*0.75):m-1]**4)+Wlin[11]*(x[int(m*0.75):m-1]**3)+Wlin[12]*(x[int(m*0.75):m-1]**2)+Wlin[13]*(x[int(m*0.75):m-1]**1)+Wlin[14]*(x[int(m*0.75):m-1]**0)
    ...
    ax[0].plot(x_new, func_y_regress, color=color_test[num], label="traning model_m="+str(m), linewidth=5)
    ...
    for a in np.arange(0, len(x)):
        ...
        for d in np.arange(0, 15):
            for i in np.arange(0, len(training_data_LOOCV)):
                X_matrix[i][d]=training_data_LOOCV[i]**(14-d)
    ...
    ax[0].plot(x, y_regress_LOOCV_2, color=color_LOO[num], label="leave-one-out m="+str(m), linewidth=2.5)
    plt.ylim(y.min(), y.max())
    plt.xlim(x.min(), x.max())
    ...
    ax[0].plot(x_new,func_y_regress_Five_5, color=color_Five[num], label="Five-Fold m="+str(m), linewidth=1.5)
    ...
    print(block[2][num])
    collabel=("testing error", "Leave-one-out error", "Five-Fold error", "m")
