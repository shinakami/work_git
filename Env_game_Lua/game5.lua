     ...
     local function spotcard()
      if(hint==0)then
        ...
        if(hintchoice==1)then
          local earth = display.newImageRect(sceneGroup, "earth.png", 134, 230 )
              earth.x = 86
              earth.y = 145
        end
        ...
        if(hintchoice==3)then
           local water = display.newImageRect(sceneGroup, "water.png", 134, 230 )
              water.x = 86
              water.y = 145
    ...
    elseif ( phase == "did" ) then
      ...
      local function touch1()
        if(confirm==1 or confirm==2)then
          ...
          display.newText(sceneGroup,"WIN",201,20,system.nativeFont,15.5)
          ...
          local dispObj_5 = display.newImageRect(sceneGroup, "earthblack.png", 134, 230 ) -----deidare result
            dispObj_5.x = 86
            dispObj_5.y = 131
          physics.addBody( dispObj_5, "dynamic", { density=1, friction=0.3, bounce=0.2 } )
      ...
      local function touch2()
        ...
        if(confirm==1 or confirm==2)then
            ...
            display.newText(sceneGroup,"WIN",201,20,system.nativeFont,15.5)
            display.newText(sceneGroup,"LOSE",57,20,system.nativeFont,15.5)
        ...
        local function touch3()
          if(confirm==1 or confirm==2)then
            ...
            display.newText(sceneGroup,"LOSE",201,20,system.nativeFont,15.5) ------player result
